...
const NAV_ITEMS = [
  ...
  { id: 'water_management', label: 'Visualization Work',     icon: '🗺️', group: 'Navigation' },
  { id: 'petty_cash',       label: 'Petty Cash',             icon: '💵', group: 'Navigation' },
  { id: 'park_plus',        label: 'Park+ Payments',         icon: '🅿️', group: 'Navigation' },
