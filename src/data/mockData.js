...
export const fixedDeposits = [
  {
    id: 'FD-HDFC-01',
    fdNumber: '50301245622387',
    fdNumberColor: '#333333',
    fdNumberUnderline: false,
    bankName: 'HDFC Bank',
    depositLine1: 'MAJESTIQUE EURISKA A BLDG',
    depositLine2: 'SA GRU SAN MAR (Sole Owner)',
    depositLine2Color: '#555555',
    depositName: 'MAJESTIQUE EURISKA A BLDG SA GRU SAN MAR',
    purpose: 'Sole Owner',
    principal: 2500000,
    interestRate: 6.60,
    tenureMonths: 20,
    startDate: '2025-11-12',
    maturityDate: '2027-07-14',
    maturityValue: 2788610,
    fundType: 'General Fund',
    status: 'Active',
    notes: 'Primary HDFC Fixed Deposit - Sole Owner account'
  },
  {
    id: 'FD-HDFC-02',
    fdNumber: '50301245623571',
    fdNumberColor: '#1565c0',
    fdNumberUnderline: true,
    bankName: 'HDFC Bank',
    depositLine1: 'MAJESTIQUE EURISKA A BLDG',
    depositLine2: 'SA GRU SAN MAR (SWIP)',
    depositLine2Color: '#1565c0',
    depositName: 'MAJESTIQUE EURISKA A BLDG SA GRU SAN MAR',
    purpose: 'SWIP',
    principal: 242714,
    interestRate: 6.60,
    ...
    maturityValue: 267733,
    fundType: 'SWIP Fund',
    status: 'Active',
    notes: 'HDFC SWIP Fixed Deposit'
  },
  {
    id: 'FD-HDFC-03',
    fdNumber: '50301245627975',
    fdNumberColor: '#2e7d32',
    fdNumberUnderline: true,
    bankName: 'HDFC Bank',
    depositLine1: 'MAJESTIQUE EURISKA A BLDG',
    depositLine2: 'SGSM SINKING FUND (SINKING)',
    depositLine2Color: '#2e7d32',
    depositName: 'MAJESTIQUE EURISKA A BLDG SGSM SINKING FUND',
    purpose: 'SINKING',
    principal: 142000,
    interestRate: 6.60,
    tenureMonths: 18,
    startDate: '2025-11-12',
    maturityDate: '2027-05-13',
    maturityValue: 156637,
    fundType: 'Sinking Fund',
    status: 'Active',
    notes: 'SGSM Sinking Fund FD'
  },
  {
    id: 'FD-ICICI-01',
    fdNumber: '033705501661',
    fdNumberColor: '#e65100',
    fdNumberUnderline: true,
    bankName: 'ICICI Bank',
    depositLine1: 'ICICI FIXED DEPOSIT',
    depositLine2: null,
    depositLine2Color: null,
    depositName: 'ICICI FIXED DEPOSIT',
    purpose: 'General',
    principal: 570529,
    interestRate: 7.25,
    tenureMonths: 24,
    ...
    maturityValue: 658608,
    fundType: 'Reserve Fund',
    status: 'Active',
    notes: 'ICICI Bank Fixed Deposit'
  }
];
